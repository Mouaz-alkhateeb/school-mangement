                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-danger">{{trans('Students_trans.Previous_Stage')}}</th>
                                             <th class="alert-danger">{{trans('Students_trans.Previous_Study_Year')}}</th>
                                            ...
                                            <th class="alert-success">{{trans('Students_trans.Current_Study_Year')}}</th>
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#Delete_one{{$promotion->id}}">{{trans('Students_trans.Back')}} </button>
                                                    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#">{{trans('Students_trans.Graduate')}} </button>
                                                </td>
                                            </tr>
